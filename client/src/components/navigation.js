        ...
        return(
            <Nav bsStyle="tabs" activeKey="1" onClick={this.handleSelect.bind(this)}>
                ...
                <NavDropdown eventKey="2" title="Gallery" id="nav-dropdown">
                    ...
                    <MenuItem eventKey="2.3" href="/gallery/pencil">pencil</MenuItem>
                    <MenuItem eventKey="2.4" href="/gallery/color">color</MenuItem>
                </NavDropdown>
                <NavItem eventKey="3" href="/biography" title="/biography">Biography</NavItem>
                <NavItem eventKey="4" href="/orders">Orders</NavItem>
                <NavItem eventKey="4" href="/lessons">Lessons</NavItem>
                <NavItem eventKey="5" href="/exhibitions">Exhibitions</NavItem>
            </Nav>
        );
    }
